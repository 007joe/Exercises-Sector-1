...
public class Exercises {
	...
	public String makeTags(String tag, String word) {
		String tagger = new String("<" + tag + ">" + word + "</" + tag + ">");
		return tagger;
	}
	...
	public String makeOutWord(String out, String word) {
		String midIncluded = (out.substring(0, 2) + word + out.substring(2, 4));
		return midIncluded;
	}
	...
	public String extraEnd(String str) {
		String chars2 = str.substring(str.length() - 2) + str.substring(str.length() - 2) + str.substring(str.length() - 2);
		return chars2;
	}
	...
	public String firstHalf(String str) {
		String first3 = str.substring(0, (str.length() / 2));
		return first3;
	}
	...
	public String withoutEnd2(String str) {
		if (str.length() < 3) {
			...
			String doubleSlice = new String(str.substring(1, (str.length() - 1)));
			return doubleSlice;
		}
	}
	...
	public String nTwice(String str, int n) {
		String nTwiceF = str.substring(0, 0 + n);

		String nTwiceB = str.substring(str.length() - n);
		return nTwiceF + nTwiceB;
	}
	...
	public String stringBits(String str) {
		...
		for (int b = 0; b < str.length(); b = b + 2) {
			stringbits = stringbits + str.substring(b, b + 1);
