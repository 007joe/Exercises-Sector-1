...
public class Exercises {
	...
	public String[] list2Array(List<String> stringList) {
		String[] list2Array = stringList.toArray(new String[0]); {
			return list2Array;
		}
	};
...
for (String words: stringArray) {
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
		...
		for(Integer divide2: intArray) {
			dividedNumbers.add(divide2 / 2.0);
		};
	...
	public List<Integer> oddOnly(Integer[] integerArray) {
		...
		for (Integer oddPush: integerArray) {
			if (oddPush % 2 !=0) {
				oddValues.add(oddPush);
			}
		}
		return oddValues;
	};
	...
	** INTERVIEW QUESTION **
	...
	List<String> newFizz = new ArrayList<>();
